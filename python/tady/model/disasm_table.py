...
OP_RELATIVE = 0x20
OP_MODRM = 0x40
OP_PREFIX = 0x80  # This seems to be a duplicate of OP_INVALID, but I'll keep it as defined.
...
flags_table = [
    ...
    OP_NONE,
    # A0
    OP_DATA_I16_I32_I64,  # OP_DATA_I8
    # A1
    OP_DATA_I16_I32_I64,
    # A2
    OP_DATA_I16_I32_I64,  # OP_DATA_I8
...
INSTRUCTION_CONTROL_FLOW_KIND = {
    ...
    # Return-like far transfer (SYSRET, SYSEXIT, IRET, FAR RET)
    'FAR_RETURN': 7,
